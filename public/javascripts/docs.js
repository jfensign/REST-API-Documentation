(function($) {
    ...
    var allEndpoints = $('li.endpoint'),
        ...
        username = getQueryStringValue("un"),
        password = getQueryStringValue("pw");
    ...
    */
    $('li.method form').submit(function(event) {
        ...
        .complete(function(result, text) {
            ...
            response_obj = JSON.parse(response.response);



            if(response_obj.Auth) {
             $(".request_token_input").val(response_obj.Auth.RequestToken)
            }
